...
--
-- Host: localhost:3008
-- Generation Time: Jun 11, 2021 at 02:57 PM
...
(7, 'rahul kumar', 'Woodness Liberty Solid Wood Bunk Bed  (Finish Color - Dark Brown)', 28, '12403', '12371', '9973910344', 'rahulkumar41999@gmail.com', 'confirm'),
(8, 'Sabyasachi', 'Woodness Liberty Solid Wood Bunk Bed  (Finish Color - Dark Brown)', 28, '12409', '12371', '6294683141', 'sachisabya41999@gmail.com', NULL),
(9, 'Sabyasachi', 'Embroidered Fashion Cotton Blend Saree  (Green)', 27, '617', '498', '6294683141', 'sachisabya41999@gmail.com', NULL);
...
(26, 'Acer Predator Helios 300', 'Laptop', '94990', 'acer laptop1.jpeg', 'acer laptop2.jpeg', 'acer laptop3.jpeg', '2021-06-21T21:54', '\r\nSales Package\r\n2 in 1 Laptop, Power Adaptor, User Guide, Warranty Documents\r\nModel Number\r\n14IIL05\r\nPart Number\r\n81X100NDIN\r\nSeries\r\nIdeapad Flex 5\r\nColor\r\nGraphite Grey\r\nType\r\n2 in 1 Laptop\r\nSuitable For\r\nProcessing & Multitasking\r\nBattery Backup\r\nUpto 10 hours\r\nPower Supply\r\n65 W AC Adapter\r\nMS Office Provided\r\nYes', 'sachisabya41999@gmail.com', 1),
(27, 'Embroidered Fashion Cotton Blend Saree  (Green)', 'Clothes(Female)', '498', 'girl saree1.jpeg', 'girl saree2.jpeg', 'girl saree3.jpeg', '2021-06-11T03:39', 'Style Code\r\nAARS-001AAAGREEN\r\nPattern\r\nEmbroidered\r\nPack of\r\n1\r\nOccasion\r\nParty & Festive\r\nType of Embroidery\r\nZarodosi Embroidery\r\nHand Embroidery\r\nno\r\nEmbroidery Method\r\nMachine\r\nConstruction Type\r\nmachine\r\nFabric Care\r\nWash with Like Colors\r\nFabric\r\nCotton Blend\r\nType\r\nFashion\r\nBlouse Piece\r\nUnstitched\r\nSari Style\r\nRegular Sari\r\nSari Length\r\n5.5\r\nBlouse Piece Length\r\n0.75\r\nWeight\r\n0.3', 'ghoshsupriya159@gmail.com', 1),
(28, 'Woodness Liberty Solid Wood Bunk Bed  (Finish Color - Dark Brown)', 'Furniture', '12371', 'furniture1.jpeg', 'furniture2.jpeg', 'furniture3.jpeg', '2021-09-27T22:15', 'Bed Size: Single\r\nBed Design: Standard Bunk Bed\r\nHeight x Width: 1515 mm x 1975 mm (4 ft 11 in x 6 ft 5 in)\r\nKnock Down - Delivered in non-assembled pieces, installation by service partner', 'rachita666@gmail.com', 1),
(29, 'avatar', 'Laptop', '2000', '_DSC0616.JPG', '_DSC0553.JPG', '_DSC0567.JPG', '2021-07-19T04:06', 'fhj,k,', 'sachisabya41999@gmail.com', 1);
...
(62, 'Parmila Shah', 'parmilashah419@gmail.com', '153c69a56beaee5827d08e2f18b14b54', '9931790882', '', '1998-02-28', 'Female', 'krishnapur ,arambhag,bradhaman,westbengal-734897', '', 'United States', 'West Bengal', 734897, 'default.png', '2021-05-23 19:22:30');
...
(18, 'sachisabya41999@gmail.com', 'ecc7dc039500ba33618c6105689ff354');
...
--
ALTER TABLE `bidders`
  MODIFY `bidder_id` int(250) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `registration`
  MODIFY `serial_number` int(250) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;
